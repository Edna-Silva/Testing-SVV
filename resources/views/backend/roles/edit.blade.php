        ...
        <div class="table w-full mt-8 bg-white rounded">
            <form action="{{ route('role.update',$role->id) }}" method="POST" class="w-full max-w-lg px-6 py-12">
                ...
                <div class="md:flex md:items-center">
                    ...
                    <div class="md:w-2/3">
                        <button class="shadow bg-blue-500 hover:bg-blue-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="submit" style="background-color: #132043; hover: background-color: #1a2b48;">
                            Update Role
                        </button>
                    </div>
                </div>
