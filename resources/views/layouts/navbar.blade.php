<head>
    ...
    <style>
        ...
        body, .font-semibold, .font-semibold {
            font-family: 'RopasoftPro', sans-serif;
        }
    </style>
</head>

<div class="px-4 sm:px-6 py-3 flex items-center justify-between shadow h-16 fixed top-0 left-0 right-0 z-50" style="background-color: #132043;">
    <div class="flex items-center text-white">
        <img src="{{ asset('images/nust-sponsor-logo.png') }}" alt="NUST Elearning Logo" class="h-8 w-auto mr-2">  
        
        <span class="font-semibold text-sm sm:text-xl tracking-tight">NUST ELEARNING</span>
    </div>
    <div class="relative">
        @auth
            ...
            <div class="absolute top-0 right-0 mt-12 -mr-6 shadow rounded-bl rounded-br" style="background-color: #132043;">
